...
export const faqSchema = {
  ...
  "mainEntity": [
    ...
    },
    {
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Our cancellation policy is available at [Cancellation Policy](https://sukhakartaholidayhome.in/cancellation-policy). For the most current terms, please review the policy page or contact us at +91 80875 41496."
      }
    },
    {
      "@type": "Question",
