// FILE: src/app/api/cron/vitals-batch3/route.ts
...
const PAGES = [
  "/stay/near-alibaug-beach",
  "/stay/near-varsoli-beach",
  "/stay/weekend-getaway-from-mumbai",
  "/stay/family-homestay-alibag",
  "/stay/couple-homestay-alibag",
];
